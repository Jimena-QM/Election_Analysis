...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        vote_county_prc = float(vote_county) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        county_results = (f'{county_name}: {vote_county_prc: .1f}% ({vote_county:,})')
        ...
        if(vote_county > winning_count):
            ...
            #Votes of the county with the most votes
